...
if(isset($_REQUEST['submit'])){
    ...
    if (empty($error_message)) {
        ...
        $con = mysqli_connect('localhost', 'root', '', 'test_roman');

        $sql = "INSERT INTO registration (name, email, username, password, gender, dob) VALUES ('$name', '$email', '$username', '$password', '$gender', '$dob')";
